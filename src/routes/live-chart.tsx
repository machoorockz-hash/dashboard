...
export const Route = createFileRoute("/live-chart")({
  head: () => ({
    meta: [
      { title: "Live Chart — CryptoHunt" },
      { name: "description", content: "Live Binance candlestick chart with EMA 200/21/9 for any symbol." },
    ],
  }),
            ...
            {QUICK.map((s) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border text-sm font-bold shrink-0 transition-colors ${
